...
#excluding HF183.qc, NoV.GIA.esv + NoV.GIB.esv + NoV.GII.esv + PMMoV.esv + 
set.seed(1)
...
#excluding AdV.qc +	HF183.qc, NoV.GIA.esv + NoV.GIB.esv + NoV.GII.esv + PMMoV.esv + 
set.seed(1)
train_cubist <- train(recovery ~ old.recovery +	Facility_letter + type_letter + storage.time.days +	CP56_nc	+ HF183_nc + HF183.esv + AdV.esv + EnT.esv + 
                        AdV_nc +	EnT_nc +	NoV.GIA_nc +	NoV.GIB_nc +	NoV.GII_nc +	PMMoV_nc +	 
...
#excluding NoV.GII.qc + AdV.qc +	HF183.qc, NoV.GIA.esv + NoV.GIB.esv + NoV.GII.esv + PMMoV.esv + 
set.seed(1)
train_cubist <- train(recovery ~ old.recovery +	Facility_letter + type_letter + storage.time.days +	CP56_nc	+ HF183_nc + HF183.esv + AdV.esv + EnT.esv + 
                        AdV_nc +	EnT_nc +	NoV.GIA_nc +	NoV.GIB_nc +	NoV.GII_nc +	PMMoV_nc +	 
...
#excluding HF183_nc +  NoV.GII.qc + AdV.qc +	HF183.qc, NoV.GIA.esv + NoV.GIB.esv + NoV.GII.esv + PMMoV.esv + 
set.seed(1)
